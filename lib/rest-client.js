...
module.exports = class RestClient {
  ...
  async cancelActiveOrder(params) {
    ...
    assert(params.symbol, "Parameter symbol is required");
    assert(
      params.order_id || params.order_link_id,
      "Parameter order_id OR order_link_id is required"
    );
  ...
  async cancelConditionalOrder(params) {
    ...
    assert(params.symbol, "Parameter symbol is required");
    assert(
      params.stop_order_id || params.order_link_id,
      "Parameter stop_order_id OR order_link_id is required"
    );
  ...
  async getTradeRecords(params) {
    ...
    assert(
      ...
      "Parameter order_id OR symbol is required"
    );
